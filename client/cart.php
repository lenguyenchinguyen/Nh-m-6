    ...
    <div class="card-body">
      <form action="cart.php" method="post">
              ...
              <?if (isset ($_SESSION['cart'])) : ?>
                ...
                <?php foreach ($_SESSION['cart'] as $item) : ?>
                  ...
                  <tr>
                    ...
                    <td class="text-center align-middle px-0" ><button type=submit name="xoacart" value="<?= $item['id'] ?>"  class="shop-tooltip close float-none text-light btn btn-danger">x</button></td>
        ...
        <div class="float-right">
          <a href="index.php?pages=category" class="text-decoration-none text-dark">Quay lại</a>
          <a href="index.php?pages=checkout" class="btn btn-lg btn-success mt-2 float-end">Thanh toán</a>
